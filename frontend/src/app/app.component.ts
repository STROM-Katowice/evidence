...
@Component({
  selector: 'app-root',
  imports: [RegalComponent, SearchComponent, PeopleComponent, EventsComponent, SettingsComponent, GroupsComponent, DetailsComponent, QualsComponent],
...
export class AppComponent {
  ...
  getBrigades(){
    return this.dataService.groups.filter((x:any) => x.location==this.site.name && x.category=="Brygady");
  }
