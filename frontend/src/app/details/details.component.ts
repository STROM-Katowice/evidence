...
export class DetailsComponent {
  ...
  async changeName(name:string){
    ...
    const r1=await fetch(this.dataService.remote+'item/name', {  //<- very sketchy shit
      method: "POST",
  ...
  async changeAbsence(a:string){
    ...
    const r1=await fetch(this.dataService.remote+'item/absence', {
      method: "POST",
      headers: { 
  ...
  async selectImg(idx:number){
    ...
    const r1=await fetch(this.dataService.remote+'item/img', {
      method: "POST",
  ...
  async changePerms(){
    ...
    const r1=await fetch(this.dataService.remote+'item/perms', {  //<- very sketchy shit
      method: "POST",
      headers: this.dataService._HEADERS,
      body: body
    });
  ...
  async status(num:number){
    ...
    const r1=await fetch(this.dataService.remote+'item/status', {  //<- very sketchy shit
      method: "POST",
      headers: this.dataService._HEADERS,
      body: body
    });
